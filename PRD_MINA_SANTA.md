...
```mermaid
graph TD
    A[01. Header Slim Sticky & Acceso Directo NDA] --> B[02. Hero Institucional con Fotografía Real de Mina Santa]
    B --> C[03. Bento Grid de Escala Verificada & KPI Duros 690M]
    C --> D[04. Geopolítica: El Nexo Perú-EE.UU. & Minerales de Defensa]
    D --> E[05. Activos Ancla de Liquidez Inmediata: Oro & Magnetita]
    E --> F[06. Los 7 Minerales Especiales de Alto Volumen]
    F --> G[07. Matriz Interactiva de los 32 Elementos Certificados ALS 2026]
    G --> H[08. Ficha Geológica, Calicatas & Acceso Portuario Salaverry/Chancay]
    H --> I[09. Estructuras de Inversión, Proceso de Transacción & Data Room Confidencial]
    I --> J[10. Footer Corporativo Dedicado: Oficinas EE.UU. & Perú]
```
